...
.atv-modal{background:#fff;border-radius:14px;border:1px solid var(--line,#E2E8F0);padding:14px 16px;width:100%;max-width:440px;height:auto;max-height:calc(100vh - 32px);overflow:auto;box-shadow:0 24px 48px -12px rgba(15,23,42,.25);display:flex;flex-direction:column;gap:10px;}
.atv-modal > *{margin:0;}
...
.atv-modal-foot{display:flex;justify-content:flex-end;gap:8px;margin-top:6px;}
`;