...
.ap-sidebar-slot{width:240px !important;min-width:240px !important;flex:0 0 240px !important;align-self:stretch !important;}
...
@media(max-width:820px){.ap-sidebar,.ap-sidebar-slot{display:none !important;}}
`;
...
export function AppSidebar({ active, onCmdK }: { active: SidebarKey; onCmdK?: () => void }) {
  ...
  return (
    ...
    <div className="ap-sidebar-slot" aria-hidden="true" />
