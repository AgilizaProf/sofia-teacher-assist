...
import { imprimirRelatorio } from "@/lib/documentos/relatorioPrint";
import {
  saveRelatorioDoc,
  listRelatoriosDoc,
  deleteRelatorioDoc,
            ...
            {doc ? (
              <>
                <div className="flex flex-wrap justify-end gap-2 px-4 pt-2">
                  ...
                  <Button variant="outline" size="sm" onClick={() => exportarRelatorioDocx(doc)}>
              ...
              <ul className="divide-y border rounded-md">
                {historico.map((item) => (
                  <li key={item.id} className="flex items-center justify-between px-3 py-2">
                    ...
                    <Button variant="ghost" size="sm" onClick={() => exportarRelatorioDocx(item.conteudo)} aria-label="Exportar Word">
