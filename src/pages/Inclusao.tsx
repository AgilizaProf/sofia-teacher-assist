...
.student-card{background:#e6f0ff;border:2px solid var(--accent);border-radius:13px;padding:16px;cursor:pointer;transition:.15s;position:relative;overflow:hidden;text-align:left;width:100%;}
.student-card:hover{transform:translateY(-3px);box-shadow:0 12px 26px rgba(255,140,0,.2);}
