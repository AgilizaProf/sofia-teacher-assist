...
@media(max-width:480px){
  ...
  .hero-cta,.hero-cta-ghost{width:auto;justify-content:center;white-space:normal;flex:1 1 0;min-width:0;}
...
/>
          ...
          <div
            className={`curricuo-strip${curricuoAtivo ? " ativo" : ""}`}
            onClick={() => setCurricuoOpen(true)}
            role="button"
            tabIndex={0}
            onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") setCurricuoOpen(true); }}
            aria-label="Configurar Currículo Municipal"
          >
            <div className="curricuo-icon">
              <Svg c={<><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></>} />
            </div>
            <div className="curricuo-content">
              {curricuoAtivo ? (
                <>
                  <div className="curricuo-title">Currículo Municipal ativo ✓ <span className="badge-inedito"><Svg width={10} height={10} c={<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>} /> Inédito no Brasil</span></div>
                  <div className="curricuo-sub">{curricuoNome} · clique para gerenciar ou substituir</div>
                </>
              ) : (
                <>
                  <div className="curricuo-title">Configure o Currículo Municipal <span className="badge-inedito"><Svg width={10} height={10} c={<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>} /> Inédito no Brasil</span></div>
                  <div className="curricuo-sub">Envie o PDF do seu município e a IA alinha tudo ao currículo local</div>
                </>
              )}
            </div>
            <div className="curricuo-action">
              {curricuoAtivo ? "Gerenciar" : "Configurar"}
          ...
          <form className="school-modal-body" onSubmit={async (e) => {
            ...
            <div className="school-row">
              <div className="school-field">
                ...
                <select id="class-grade" name="grade" defaultValue="" required>
